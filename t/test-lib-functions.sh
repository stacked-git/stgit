...
# Fake implementation of the "test-tool" helper tool from Git's test infrastructure.
# Only the bare minimum of subcommands are implemented.
fake_tool () {
	case "$1" in
	"date")
		case "$2" in
