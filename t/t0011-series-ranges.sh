...
test_expect_success 'Patch range args conflict with opts' '
    ...
    grep -e "error: The argument .--all. cannot be used with .<patch-range>\.\.\.." err &&
    general_error stg series -A p2.. 2>err &&
    grep -e "error: The argument .--applied. cannot be used with .<patch-range>\.\.\.." err &&
    general_error stg series --unapplied p2.. 2>err &&
    grep -e "error: The argument .--unapplied. cannot be used with .<patch-range>\.\.\.." err
'
