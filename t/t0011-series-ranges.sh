...
test_expect_success 'Patch range args conflict with opts' '
    ...
    grep -e "error: The argument .<patch-range>\.\.\.. cannot be used with .--all." err &&
    general_error stg series -A p2.. 2>err &&
    grep -e "error: The argument .<patch-range>\.\.\.. cannot be used with .--applied." err &&
    general_error stg series --unapplied p2.. 2>err &&
    grep -e "error: The argument .<patch-range>\.\.\.. cannot be used with .--unapplied." err
'
